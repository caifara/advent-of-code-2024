...
describe Day5::Part1 do
  ...
  it "counts if page is in order" do
    input = <<-INPUT
    1|2
  ...
  it "does not count if page not in order" do
    input = <<-INPUT
    2|1
  ...
  it "takes rules concerning same page into account" do
    input = <<-INPUT
    2|1
    2|3
  ...
  it "works on the given example" do
    ...
    expect(do_action(input)).to eq(143)
  end
end
